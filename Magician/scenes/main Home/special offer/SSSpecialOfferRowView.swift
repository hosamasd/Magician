...
struct SSSpecialOfferRowView: View {
    ...
    var body: some View {
            ...
            Image(x.img)
                ...
                .frame(width: getImageWidth(),height: 160)//, height: 150)//150 // 200
                .overlay(
...
//struct SSSpecialOfferRowView_Previews: PreviewProvider {
//    static var previews: some View {
//        SSSpecialOfferRowView()
//    }
//}
